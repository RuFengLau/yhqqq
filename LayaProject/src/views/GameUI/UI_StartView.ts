...
export default class UI_StartView extends fgui.GComponent {
	...
	protected onConstruct():void {
		...
		this.m_Finger = <fgui.GGroup>(this.getChildAt(2));
		this.m_Bot = <UI_GameButton>(this.getChildAt(3));
		this.m_StageLabel = <fgui.GTextField>(this.getChildAt(4));
		this.m_CoinBar = <UI_ResourceBar>(this.getChildAt(5));
		this.m_ShopBtn = <UI_GameButton>(this.getChildAt(6));
		this.m_n11 = <fgui.GButton>(this.getChildAt(7));
		this.m_n12 = <fgui.GButton>(this.getChildAt(8));
		this.m_n13 = <fgui.GButton>(this.getChildAt(9));
		this.m_n14 = <fgui.GButton>(this.getChildAt(10));
		this.m_n15 = <fgui.GImage>(this.getChildAt(11));
